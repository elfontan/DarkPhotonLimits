...
void mass_calibration(){ 
  ...
  // ---------------------------------------------------
	...
	*/
	...
	std::cout << "Frac Gaussian: " << w->var("frac_gau") -> getVal() << endl;
	...
	gr->SetMarkerStyle(21);
        gr->GetXaxis()->SetTitle("#scale[1.25]{#it{m}_{#it{#mu#mu}} [GeV]}"); 
        gr->GetYaxis()->SetTitle("#scale[1.25]{Resonance width / #it{m}_{#it{#mu#mu}} (%)}");
  ...
  gc->GetXaxis()->SetTitle("#scale[1.25]{#it{m}_{#it{#mu#mu}} [GeV]}"); 
  gc->GetYaxis()->SetTitle("#scale[1.25]{Resonance width / #it{m}_{#it{#mu#mu}} (%)}");
  ...
  frame_jpsi2018->GetYaxis()->SetTitleSize(0.053);
  frame_jpsi2018->GetYaxis()->SetTitle("Events / 2 MeV");
  frame_jpsi2018->Draw();
  c2->cd();
  TArrow* l = new TArrow(3.41,1.5,2.4,1.91, 0.015, "|>");
  //TLine* l = new TLine(3.41,1.5,2.4,1.91);
  l->Draw();
  TArrow* l2 = new TArrow(9.95,1.5,8.8,1.91, 0.015, "|>");
  //TLine* l2 = new TLine(9.95,1.5,8.8,1.91);
  l2->Draw();
    
  c2->SaveAs("/eos/user/e/elfontan/www/ScoutingParkingPaper/EXO-23-007/width_plot_combined_EXO-23-007_Jan21.png");
  c2->SaveAs("/eos/user/e/elfontan/www/ScoutingParkingPaper/EXO-23-007/width_plot_combined_EXO-23-007_Jan21.pdf");
}
