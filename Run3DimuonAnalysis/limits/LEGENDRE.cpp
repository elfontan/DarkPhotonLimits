  ...
  //INPUT FILE WITH HISTOGRAMS TO FIT BACKGROUND
   ...
   //LOOP OVER MASS INDICES AND MAKE THE CARDS/WORKSPACES
	...
	upsilon->var("res_rel_generic")->setConstant(true);
        ...
        TGraph* chi5Values = new TGraph(144);
        TGraph* chi6Values = new TGraph(144);

        TGraph* p1Values = new TGraph(144);
        TGraph* p2Values = new TGraph(144);
        TGraph* p3Values = new TGraph(144);
        TGraph* p4Values = new TGraph(144);
        TGraph* p5Values = new TGraph(144);
        TGraph* p6Values = new TGraph(144);
	...
	for(int i=0; i<400; i++){
		...
		TH1D* catLEG = new TH1D("catLEG","catLEG", nbins, -1.0, 1.0);
		for (int n=0; n<nbins+1; n++){
		  catLEG->SetBinContent(n, catA->GetBinContent(n));
		}
		catLEG->Scale(20/catLEG->Integral());
		...
		RooRealVar m2muLEG = *m2mu;
		m2muLEG.setMax(1);
		m2muLEG.setMin(-1);
		
                //RooRealVar m2muLEG("m2muLEG", "m2muLEG", 0.0, -1.0, 1.0);
		...
		RooDataHist data_obsLEG("data_obsLEG", "", RooArgList(m2muLEG), catLEG);
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                ...
                RooRealVar lara("lara", "lara", 0.2, -10.0, 10.0);
                RooRealVar larb("larb", "larb", 0.2, -10.0, 10.0);
                RooRealVar larc("larc", "larc", 0.2, -10.0, 10.0);
                RooRealVar lard("lard", "lard", 0.2, -10.0, 10.0);
                RooRealVar lare("lare", "lare", 0.2, -10.0, 10.0);
                RooRealVar larf("larf", "larf", 0.2, -10.0, 10.0);
                RooRealVar larg("larg", "larg", 0.2, -10.0, 10.0);
                RooRealVar larh("larh", "larh", 0.2, -10.0, 10.0);
                RooRealVar lari("lari", "lari", 0.2, -10.0, 10.0);
                RooRealVar larj("larj", "larj", 0.2, -10.0, 10.0);

		RooGenericPdf leg0("leg0", "leg0","1", m2muLEG);
		RooGenericPdf leg1("leg1", "leg1","@0", m2muLEG);
		RooGenericPdf leg2("leg2", "leg2","0.5*(3*@0*@0-1)", m2muLEG);
		RooGenericPdf leg3("leg3", "leg3","0.5*(5*@0*@0*@0-3*@0)", m2muLEG);
		RooGenericPdf leg4("leg4", "leg4","0.125*(35*@0*@0*@0*@0-30*@0*@0+3)", m2muLEG);
		RooGenericPdf leg5("leg5", "leg5","0.125*(63*@0*@0*@0*@0*@0-70*@0*@0*@0+15*@0)", m2muLEG);
		RooGenericPdf leg6("leg6", "leg6","0.0625*(231*@0*@0*@0*@0*@0*@0-315*@0*@0*@0*@0+105*@0*@0-5)", m2muLEG);
		RooGenericPdf leg7("leg7", "leg7","0.0625*(429*@0*@0*@0*@0*@0*@0*@0-693*@0*@0*@0*@0*@0+315*@0*@0*@0-35*@0)", m2muLEG);
		RooGenericPdf leg8("leg8", "leg8","1/128*(6435*@0*@0*@0*@0*@0*@0*@0*@0-12012*@0*@0*@0*@0*@0*@0+6930*@0*@0*@0*@0-1260*@0*@0+35)", m2muLEG);
		//RooGenericPdf leg9("leg9", "leg9","(1/128)*(429*@0*@0*@0*@0*@0*@0*@0-693*@0*@0*@0*@0*@0+315*@0*@0*@0-35@0))", m2muLEG);
		//RooGenericPdf leg10("leg10", "leg10","(1/256)*(429*@0*@0*@0*@0*@0*@0*@0-693*@0*@0*@0*@0*@0+315*@0*@0*@0-35@0))", m2muLEG);
	 	
		//RooArgList leg_list(leg0,leg1,leg2,leg3,leg4,leg5,leg6,leg7,leg8);
		//RooArgList weight_list(lara,larb,larc,lard,lare,larf,larg,larh);
		RooArgList leg_list(leg0,leg1,leg2,leg3,leg4,leg5,leg6,leg7);
		RooArgList weight_list(lara,larb,larc,lard,lare,larf,larg);
		
		RooAddPdf bkg_model_leg4("bkg_model_leg4", "bkg_model_leg4", leg_list, weight_list, true);			       
                bkg_model_leg4.chi2FitTo(data_obsLEG);
		...
		*/
		...
		/*
		RooRealVar par1_2017("par1_2017", "par1_2017", 0.2, -20, 20);
		RooRealVar par2_2017("par2_2017", "par2_2017", 1.5, -20, 20);
		RooRealVar par3_2017("par3_2017", "par3_2017", 2.0, -20, 20);
		RooRealVar par4_2017("par4_2017", "par4_2017", 2.0, -20, 20);
		...
		bkg_model_bern4_2017.chi2FitTo(data_obs);		
		

		RooRealVar par1_2018("par1_2018", "par1_2018", 0.2, -20, 20);
		RooRealVar par2_2018("par2_2018", "par2_2018", 1.5, -20, 20);
		RooRealVar par3_2018("par3_2018", "par3_2018", 2.0, -20, 20);
		RooRealVar par4_2018("par4_2018", "par4_2018", 2.0, -20, 20);
		...
		bkg_model_bern4_2018.chi2FitTo(data_obs);
		*/
		...
		RooRealVar sar1_2017("sar1_2017", "sar1_2017", 0.2, 0, 20);
		RooRealVar sar2_2017("sar2_2017", "sar2_2017", 1.5, 0, 20);
		RooRealVar sar3_2017("sar3_2017", "sar3_2017", 2.0, 0, 20);
		RooRealVar sar4_2017("sar4_2017", "sar4_2017", 2.0, 0, 20);
		RooRealVar sar5_2017("sar5_2017", "sar5_2017", 2.0, 0, 20);
		RooRealVar sar6_2017("sar6_2017", "sar6_2017", 2.0, 0, 20);
		RooRealVar sar7_2017("sar7_2017", "sar7_2017", 2.0, 0, 20);
		RooRealVar sar8_2017("sar8_2017", "sar8_2017", 2.0, 0, 20);
		RooArgList slist_2017(sar1_2017, sar2_2017, sar3_2017, sar4_2017, sar5_2017, sar6_2017, sar7_2017, sar8_2017);
		RooBernstein bkg_model_bern8_2017("bkg_model_bern8_2017", "bkg_model_bern8_2017", *m2mu, slist_2017);
		bkg_model_bern8_2017.fitTo(data_obs);		
		
		RooRealVar sar1_2018("sar1_2018", "sar1_2018", 0.2, 0, 20);
		RooRealVar sar2_2018("sar2_2018", "sar2_2018", 1.5, 0, 20);
		RooRealVar sar3_2018("sar3_2018", "sar3_2018", 2.0, 0, 20);
		RooRealVar sar4_2018("sar4_2018", "sar4_2018", 2.0, 0, 20);
		RooRealVar sar5_2018("sar5_2018", "sar5_2018", 2.0, 0, 20);
		RooRealVar sar6_2018("sar6_2018", "sar6_2018", 2.0, 0, 20);
		RooRealVar sar7_2018("sar7_2018", "sar7_2018", 2.0, 0, 20);
		RooRealVar sar8_2018("sar8_2018", "sar8_2018", 2.0, 0, 20);
		RooArgList slist_2018(sar1_2018, sar2_2018, sar3_2018, sar4_2018, sar5_2018, sar6_2018, sar7_2018, sar8_2018);
		RooBernstein bkg_model_bern8_2018("bkg_model_bern8_2018", "bkg_model_bern8_2018", *m2mu, slist_2018);
		...
		*/
		...
		RooPlot *frame = m2muLEG.frame();
		frame->SetYTitle("Events");
		frame->SetXTitle("Dimuon Mass (GeV)");
		frame->GetXaxis()->SetLabelSize(0.025);
		frame->GetYaxis()->SetLabelSize(0.025);
                frame->GetYaxis()->SetRangeUser(catLEG->GetMinimum(), catLEG->GetMaximum());


                if (nbins > 500){
		  data_obsLEG.plotOn(frame, RooFit::MarkerSize(0));}
		else{
		  data_obsLEG.plotOn(frame);}
                if (year[y] == "2017"){
		  bkg_model_leg4.plotOn(frame, RooFit::Name("pdf2"), RooFit::LineColor(3));
		  ...
		  //bkg_model_bern4_2017.plotOn(frame, RooFit::Name("pdf1"), RooFit::LineStyle(2), RooFit::LineColor(2));
                }else if (year[y] == "2018"){
		  bkg_model_leg4.plotOn(frame, RooFit::Name("pdf2"), RooFit::LineColor(3));
		  ...
		  //bkg_model_bern4_2018.plotOn(frame, RooFit::Name("pdf1"), RooFit::LineStyle(2),RooFit::LineColor(2));
		}
		...
		c_all.SaveAs("test.png");
                TH1 *testhisto = data_obsLEG.createHistogram("testhisto", m2muLEG, RooFit::Binning(nbins, -1.0, 1.0));
                TH1 *testpdf1;
                TH1 *testpdf2;
                TH1 *testpdf3;
                TH1 *testpdf4;
                if (year[y] == "2017"){
                  ...
                  testpdf2   = bkg_model_leg4.createHistogram("testpdf2"  , m2muLEG, RooFit::Binning(nbins, -1.0, 1.0));
                ...
                int noofparm1 = 4; int noofparm2 = 5; int noofparm3 = 13; int noofparm4 = 6; int noofparm5 = 6; int noofparm6 = 8;
                Double_t mychi21 = 0.; Double_t mychi22 = 0.; Double_t mychi23 = 0.; Double_t mychi24 = 0.; Double_t mychi25 = 0.; Double_t mychi26 = 0.;
		...
		*/
		...
		//int ndof1 = nbins - (noofparm1 + 1);
		int ndof2 = nbins - (noofparm2 + 1); //int ndof3 = nbins - (noofparm3 + 1); int ndof4 = nbins - (noofparm4 + 1);
                //dof1 << ndof1;
                dof2 << ndof2;
                //dof3 << ndof3; 
                //dof4 << ndof4;
		...
		//TString h_string1 = "4th order Bernstein, #chi^{2}: " + chi1 + ", N_{d.o.f.} = " + dof1.str();
                TString h_string2 = "LEG6, #chi^{2}: " + chi2 + ", N_{d.o.f.} = " + dof2.str();
		...
		*/
		...
		for(int i = 0; i<=testhisto->GetNbinsX(); i++){
		...
		*/
		...
		for(int i = 0; i<=testhisto->GetNbinsX(); i++){
		  Ratio3->SetBinContent(i, (testhisto->GetBinContent(i) - testpdf3->GetBinContent(i))/testhisto->GetBinError(i));
		}
		...
		for(int i = 0; i<=testhisto->GetNbinsX(); i++){
                  Ratio4->SetBinContent(i, (testhisto->GetBinContent(i) - testpdf4->GetBinContent(i))/testhisto->GetBinError(i));
		}
                Ratio4->SetFillStyle(3);
		Ratio4->SetLineColor(5);
		Ratio4->Draw("histsame");
		*/
		//c_all.SaveAs(Form("fitsLEG/allFits_pVal_m%.3f_%d_"+year[y]+"LEG.png",mass,i));
		c_all.SaveAs(Form("test.png"));
		numPoints++;
	}
	...
	legend->AddEntry(chi4Values,"3rd order Bern + Power law","p");
        legend->SetBorderSize(0);
	legend->Draw();
        c_fVal.SaveAs("fitsLEG/chiSq"+year[y]+"Best.png");
	...
	legendP->Draw();
	c_pVal.SetBottomMargin(1.5);
        c_pVal.SaveAs("fitsLEG/pVal"+year[y]+"Best.png");

	
        TCanvas c_probhist("c_probhist", "c_probhist", 950, 820);
	probHist.GetYaxis()->SetTitle("Counts");
	probHist.GetXaxis()->SetTitle("Probability");
	probHist.SetFillColor(4);
	probHist.SetLineColor(4);
	probHist.Draw("");
	c_probhist.SetBottomMargin(1.5);
	c_probhist.SaveAs("fitsLEG/probhist"+year[y]+".png");
