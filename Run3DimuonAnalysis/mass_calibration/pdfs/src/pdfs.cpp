...
reso_pdfs::reso_pdfs(){
  ...
  RooArgList parlist_eta(par1_eta, par2_eta, par3_eta);
  RooBernstein bkgModel_eta("bkgModel_eta", "bkgModel_eta", *m2mu_eta, parlist_eta);
  RooRealVar sig_fraction_eta("sig_fraction_eta", "",0.3,0.01,1.0); // NOTE: expand the range for the signal fraction down to almost 0
  ...
  //RooAddPdf* signalModel_eta = reso_pdfs::make_signal_model("eta", m2mu_omegaphi, 0.55, 0.5, 0.6);
  ...
  //RooRealVar sig_fraction_eta("sig_fraction_eta", "",0.2,0.01,0.8);
...
// ---------------------------------------------------------
// Describe the signal model: crystal-ball + gaussian
// ---------------------------------------------------------
